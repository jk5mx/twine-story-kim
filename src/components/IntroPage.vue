<template>
    <p>In the peaceful kingdom of Charlottesville, <br>
    King Alden and Queen Elara rule with wisdom and kindness. <br>
...
<style scoped>
.router-link-active, .router-link-exact-active, a:visited {
  color: #70c0e8; /* Set your desired color */
}
</style>